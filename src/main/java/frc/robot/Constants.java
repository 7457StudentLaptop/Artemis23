...
public final class Constants {
  ...
  //  public static final int DRIVETRAIN_PIGEON_ID = 0; // Set Pigeon ID
    ...
    public static final double PURGE_INDEXER_SPEED = -0.8;
    public static final double INDEXER_RUNSPEED = 1;
    ...
    public static final double FLYWHEEL_KF = 0.028;
    public static final double FLYWHEEL_KP = 0.03;//0.21;
    public static final double FLYWHEEL_KI = 0;
    public static final double FLYWHEEL_KD = 0.7;//0.7;
    ...
    public static final int SETSHOT_RPM = 2300; //4850 for competition. Set lower for close quartered demos
    public static final int SETSHOT_RPM_LOW = 1750;
    public static final int SETSHOT_RPM_HIGH = 5000; //was 6800 before luncheon demo
}
